...
- **Code Generation**: LLM's were helpful for building out stages such as Lex, Parse, Semantic Analysis, and Code Gen. LLM's were also helpful in explaining concepts and learning about how to work with LLVM and IR's. Lastly, it was good for building out the portability features for multiple backends such as Typescript and Java.
